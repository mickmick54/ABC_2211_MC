...
public class App {
	...
	public static void main(String[] args) {
		...
		do {
			if (nombre >= 500 ) {euro500++; nombre -=500;}
			else if (nombre >= 200 ) {euro200++; nombre -=200;}
			else if (nombre >= 100 ) {euro100++; nombre -=100;}
			else if (nombre >= 50 ) {euro50++; nombre -=50;}
			else if (nombre >= 20 ) {euro20++; nombre -=20;}
			else if (nombre >= 10 ) {euro10++; nombre -=10;}
			else if (nombre >= 5 ) {euro5++; nombre -=5;}
			else if (nombre >= 2 ) {euro2++; nombre -=2;}
			else {euro1++; nombre-=1;}
		} while (nombre>0);
